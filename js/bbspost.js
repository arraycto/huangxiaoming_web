					...
					if (data.Status == 1) {
						...
						if (data.Result.list.length == 0) {
							...
							for (var i = 0; i < data.Result.list.length; i++) {
								...
								if (data.Result.list[i].digest == 4) {//公告
								...
								} else if (data.Result.list[i].digest == 0) {//普通
								...
								} else if (data.Result.list[i].digest == 1) {//加精
								...
								} else if (data.Result.list[i].digest == 2) {//置顶
