...
(function (e, g, l) {
    ...
    if (!(h.count > 0)) {
        ...
        a.loadButtonStyle = function () {
            if (c.type != 15) {
                var f, e = b.style;
                if (b.beta) f = a.jsBasePath + "styles/bshareS888.js?v=20180226";
                else if (b.popjs) f = b.popjs;
                else if (b.style != -1 && (f = a.jsBasePath + "styles/bshareS" + (e > 1 && e < 6 ? e : 1) + ".js?v=20180226", b.pop == -1 && (e <= 1 || e >= 6))) f = "";
                f && d.loadScript(f)
            }
        };
        a.international =
            function (c) {
                b.lang == "zh" ? c() : d.loadScript(a.jsBasePath + "langs/bs-lang-" + b.lang + ".js?v=20180226", c)
            };
        a.start = function () {
            d.loadEngine && (d.loadEngine(e), a.loadOptions(), a.international(function () {
                if (!a.completed) {
                    ...
                    a.createBox();
                    b.mdiv >= 0 && c.type != 15 && d.loadScript(a.jsBasePath + "components/bsMore.js?v=20180226");
                    ...
                    setTimeout(function () {
                        h.viewed || a.view();
                        setTimeout(function () {
                            h.bShareLoad || d.loadScript(a.jsBasePath + "components/bsPlatforms.js?v=20180226")
                        }, 3E3)
                    }, 3E3);
                    a.completed = !0
                }
        ...
        a.init = function () {
            if (!a.isReady) a.isReady = !0, d.loadScript(a.shost + "/js/libs/fingerprint2.min.js"), d.loadScript(a.jsBasePath + "engines/bs-engine.js?v=20180226", a.start)
        };
        d.loadScript(a.jsBasePath + "components/bsStatic.js?v=20180226")
    }
